...
export const WIDGET_REGISTRY: WidgetMeta[] = [
    ...
    {
        type: 'roomclimate',
        label: 'Raumklima-Balken (aufklappbar)',
        shortLabel: 'Klima-Balken',
        Icon: Thermometer,
        iconName: 'Thermometer',
        color: '#06b6d4',
        defaultW: 21,
        ...
        addMode: 'datapoint',
        widgetGroup: 'control',
        mock: { t: 'Wohnzimmer', v: '21.4', u: '°C' },
        hint: 'Kompakter Temperatur-Balken; klappt Details mit Luftfeuchte, Min/Max und Verlaufsdiagramm auf',
    },
    {
        type: 'rainstation',
        label: 'Regen-Stationskarte (Wechsler)',
        shortLabel: 'Regen-Station',
        Icon: CloudRain,
        iconName: 'CloudRain',
        color: '#3b82f6',
        defaultW: 21,
        ...
        addMode: 'free',
        widgetGroup: 'control',
        mock: { t: 'Anna-Haag-Ring', v: '3.1', u: 'mm' },
        hint: 'Karte mit Stations-Wechsler (◀ ▶ und Punkte): Tagesmenge und letzte Stunde groß, Gestern und Aktuell als Zusatzzeile',
    },
    {
        type: 'raindaily',
        label: 'Regenmenge pro Tag (Balken/Monat)',
        shortLabel: 'Regen-Tage',
        Icon: CloudRain,
        iconName: 'CloudRain',
        color: '#3b82f6',
        defaultW: 21,
    ...
    },
    {
        ...
        addMode: 'free',
        widgetGroup: 'control',
        mock: { t: 'Heizung', v: 'Heizt', u: '' },
        hint: 'Wärmepumpe Stiebel LWZ 304 Trend: Betriebsmodus (Heizen/Warmwasser), Kennzahlen und Steuerung',
    },
    {
        type: 'weatherforecast',
        label: 'Wetter-Vorhersage (7 Tage + Nowcast)',
        shortLabel: 'Wetter-Vorhersage',
        Icon: CloudRain,
        iconName: 'CloudRain',
        color: '#2f7fd6',
        defaultW: 21,
        ...
        hint: 'Aktuelle Werte, 7 aufklappbare Tages-Karten mit Stundenverlauf, Regen-Nowcast (15-Min-Takt) und Radar-Platzhalter',
    },
    {
        type: 'weatherforecaststrip',
        label: 'Wetter-Vorhersage (Streifen)',
        shortLabel: 'Wetter-Streifen',
        Icon: CloudRain,
        iconName: 'CloudRain',
        color: '#2f7fd6',
        defaultW: 21,
        ...
        widgetGroup: 'control',
        mock: { t: 'Wetter', v: '23°C', u: '' },
        hint: 'Wischbarer 7-Tage-Streifen (DWD-Stil) mit einem gemeinsamen Detailpanel darunter: Chart (Temperatur, Niederschlag, Regenwahrscheinlichkeit) + Sonne/Niederschlag/Temperatur-Kennzahlen',
    },
    {
        type: 'echart',
    ...
    {
        type: 'autolist',
        label: 'Dynamische Liste',
        shortLabel: 'Dynamische Liste',
        Icon: List,
        iconName: 'List',
        color: '#14b8a6',
        defaultW: 10,
    ...
    {
        type: 'trashSchedule',
        label: 'Müllabfuhr-Zeitplan',
        shortLabel: 'Müllabfuhr-Zeitplan',
        Icon: CalendarCheck2,
    ...
    {
        type: 'fill',
        label: 'Füllstandsanzeige',
        shortLabel: 'Füllstand',
        Icon: Droplets,
        iconName: 'Droplets',
        color: '#0ea5e9',
        defaultW: 8,
    ...
    },
    {
        ...
        addMode: 'datapoint',
        widgetGroup: 'control',
        mock: { t: 'Drehregler', v: '65', u: '%' },
        hint: 'Wert über Drehknopf einstellen – 3 Zeigertypen (Linie/Kreis/Pfeil), Winkelbereich konfigurierbar',
    },
    {
        type: 'timer',
        label: 'Zeitschaltuhr',
...
/** Fast lookup by type */
export const WIDGET_BY_TYPE = Object.fromEntries(WIDGET_REGISTRY.map((m) => [m.type, m])) as Record<
    WidgetType,
    WidgetMeta
>;
